...
| 2.A — Plataforma central (Diseño) | Diseñar componentes compartidos. | Sprint Specification, Implementation Plan, Tasks y criterios de aceptación aprobados. | Sprint 1.B | Completed |
