...
| 2.B — Plataforma central (Implementación) | Implementar Homelab Runtime Engine y desplegar el primer dominio. | Motor ejecutado y capacidades iniciales aprovisionadas (Tailscale, Caddy, home.arpa). | Sprint 2.A | In Review |
