...
| 2.B — Plataforma central (Implementación) | Implementar Homelab Runtime Engine y desplegar el primer dominio. | Motor ejecutado y capacidades iniciales aprovisionadas (Tailscale, Caddy, home.arpa). | Sprint 2.A | Completed |
| 3.A — Respaldo (Diseño) | Diseñar protección y recuperación de datos. | Sprint Specification, Implementation Plan, Tasks y criterios de aceptación aprobados. | Sprint 2.B | In Progress |
